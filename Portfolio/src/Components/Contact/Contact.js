    ...
    <Zoom className="contactDiv" in={checked1}>
      ...
      >
        ...
        >
          ...
          >
            <i className="fa-brands fa-github"></i> RajshreeJaiswal
          </a>
          <a
            id="contact-linkedin"
            className="socialLogo"
          ...
          >
            <i className="fa-brands fa-linkedin"></i> Rajshree Jaiswal
          </a>
          <a
            id="contact-phone"
            className="socialLogo"
          ...
          >
            <i className="fa-solid fa-phone"></i> +91-8303416224
          </a>
          <a
            id="contact-email"
            className="socialLogo"
          ...
          >
            <i className="fa-regular fa-envelope"></i> rajshreejaiswal0907@gmail.com
          </a>
        </Box>
      </Box>
    </Zoom>
